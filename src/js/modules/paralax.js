...
window.onload = function () {
  ...
  if (paralax) {
    ...
    function setMouseParalaxStyle() {
      ...
      ellipseFirst.style.cssText = `transform: translate(${
        positionX / forEllipse
      }%,${positionY / forEllipse}%);`;
      ellipseSecond.style.cssText = `transform: translate(${
        positionX / forEllipse
      }%,${positionY / forEllipse}%);`;
      ellipseThird.style.cssText = `transform: translate(${
        positionX / forEllipse
      }%,${positionY / forEllipse}%);`;
      starFirst.style.cssText = `transform: translate(${positionX / forStar}%,${
        positionY / forStar
      }%);`;
      starSecond.style.cssText = `transform: translate(${
        positionX / forStar
      }%,${positionY / forStar}%);`;
