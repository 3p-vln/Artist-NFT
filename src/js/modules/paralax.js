...
window.onload = function () {
  ...
  if (paralax) {
    ...
    function setMouseParalaxStyle() {
      ...
      mainEllipseFirst.style.cssText = `transform: translate(${positionX / forEllipse}%,${
        positionY / forEllipse
      }%);`;
      mainEllipseSecond.style.cssText = `transform: translate(${positionX / forEllipse}%,${
        positionY / forEllipse
      }%);`;
      mainEllipseThird.style.cssText = `transform: translate(${positionX / forEllipse}%,${
        positionY / forEllipse
      }%);`;
      mainStarFirst.style.cssText = `transform: translate(${positionX / forStar}%,${
        positionY / forStar
      }%);`;
      mainStarSecond.style.cssText = `transform: translate(${positionX / forStar}%,${
        positionY / forStar
      }%);`;
      mainStarThird.style.cssText = `transform: translate(${positionX / forStar}%,${
        positionY / forStar
      }%);`;

      contactSapphireFirst.style.cssText = `transform: translate(${positionX / forContact}%,${
        positionY / forContact
      }%);`;
      contactSapphireSecond.style.cssText = `transform: translate(${positionX / forContact}%,${
        positionY / forContact
      }%);`;
      contactSapphireThird.style.cssText = `transform: translate(${positionX / forContact}%,${
        positionY / forContact
      }%);`;
      contactCube.style.cssText = `transform: translate(${positionX / forContact}%,${
        positionY / forContact
      }%);`;
